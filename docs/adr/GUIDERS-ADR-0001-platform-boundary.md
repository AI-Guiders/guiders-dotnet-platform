...
3. **Platform = contracts + kits + mechanical canon**, not UI:
   ...
   - **Cockpit** — DAL/Transport/CCU/Channel/CDS/Compositor/DataBus/IDS **layer seams** (UI-free)
...
AIGuiders.Platform.Cockpit  (DAL→…→snapshot + IDS search)
...
- `AIGuiders.Platform.Cockpit` — layer canon (see GUIDERS-ADR-0002 gap matrix)
