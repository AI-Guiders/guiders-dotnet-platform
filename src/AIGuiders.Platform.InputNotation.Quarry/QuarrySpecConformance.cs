...
{
    public static IReadOnlyList<string> ValidateDocument(IInputNotationReader reader, QuarrySpecDocument spec)
    {
    ...
    public static bool TryValidateVector(IInputNotationReader reader, QuarrySpecVector vector, out string error)
    {
        error = "";
